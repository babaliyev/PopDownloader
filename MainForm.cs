...
namespace PopDownloader
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            countCmd.CommandText = "SELECT COUNT(*) FROM mails";
        ...
        public void getMessages()
        {
            try
            {
                ...
                {
                    proseccMessage(client.GetMessage(i), count + (messageCount - i + 1));
                }
        ...
        public void proseccMessage(OpenPop.Mime.Message msg, decimal id)
        {
            ...
            mailCmd.Parameters["@title"].Value = String.IsNullOrEmpty(msg.Headers.Subject) ? DBNull.Value : (object)msg.Headers.Subject;            
            ...
            foreach (OpenPop.Mime.Header.RfcMailAddress addr in msg.Headers.To)
            {
                ...
                recieverCmd.Parameters["@email"].Value = addr.Address;
